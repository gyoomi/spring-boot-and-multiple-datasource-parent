 ...
 */
@Configuration
@MapperScan(basePackages = "com.gyoomi.multipledatasource.mybatis.druid.dao.ds1", sqlSessionFactoryRef = "ds1SqlSessionFactory")
public class Ds1DatasourceConfig
{
	...
	@Value("${spring.datasource.druid.ds1.driver-class-name}")
