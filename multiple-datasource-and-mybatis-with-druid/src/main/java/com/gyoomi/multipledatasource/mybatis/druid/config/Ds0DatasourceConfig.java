 ...
 */
@Configuration
@MapperScan(basePackages = "com.gyoomi.multipledatasource.mybatis.druid.dao.ds0", sqlSessionFactoryRef = "ds0SqlSessionFactory")
public class Ds0DatasourceConfig
{

	@Value("${spring.datasource.druid.ds0.url}")
	private String jdbcUrl;

	@Value("${spring.datasource.druid.ds0.username}")
	private String username;

	@Value("${spring.datasource.druid.ds0.password}")
	private String password;

	@Value("${spring.datasource.druid.ds0.driver-class-name}")
